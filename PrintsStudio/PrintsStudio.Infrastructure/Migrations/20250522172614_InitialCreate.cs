        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DesignerProfileDesignerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DesignerProfileDesignerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductDesignTemplateId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDesignTemplates", x => x.ProductDesignTemplateId);
                    table.ForeignKey(
                        name: "FK_ProductDesignTemplates_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedDesignTemplateId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_ProductDesignTemplates_SelectedDesignTemplateId",
                        column: x => x.SelectedDesignTemplateId,
                        principalTable: "ProductDesignTemplates",
                        principalColumn: "ProductDesignTemplateId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DesignerProfileDesignerId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_SelectedDesignTemplateId",
                table: "OrderItems",
                column: "SelectedDesignTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDesignTemplates_ProductId",
